...
import com.chen.picture.manager.FileManager;
import com.chen.picture.model.dto.picture.PictureEditRequest;
import com.chen.picture.model.dto.picture.PictureQueryRequest;
import com.chen.picture.model.dto.picture.PictureUpdateRequest;
...
import com.chen.picture.model.vo.PictureTagCategoryVO;
...
public class PictureController {
     ...
     */
    @PostMapping("/update")
    @AuthCheck(mustRole = UserContant.ADMIN_ROLE)  //@RequestBody 能够将这些JSON数据转换成 Java 对象，通常是实体类或 DTO
